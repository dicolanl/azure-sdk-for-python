...
class IncidentCommentsOperations(object):
    ...
    def list_by_incident(
        ...
        deserialized = models.IncidentCommentPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.IncidentCommentPaged(internal_paging, self._deserialize.dependencies, header_dict)
